        ...
        <section id="fascia_azzurra" className="grid grid-cols-3 xs:grid-cols-1">
            ...
            <div className="colonna_destra col-span-2">
                ...
                <div className="loghetti flex-wrap">
                    ...
                    <div className="loghetti inline-block">
                        <Image width="50" height="50" alt="React" title="React" src={"/images/loghetto-react.svg"} />
                        <p>React</p>
                    </div>
                    <div className="loghetti inline-block">
                        <Image width="50" height="50" alt="Next.Js" title="Next.Js" src={"/images/loghetto-nextjs.svg"} />
                        <p>Next.Js</p>
                    </div>
                    <div className="loghetti inline-block">
                        <Image width="50" height="50" alt="Git" title="Git" src={"/images/loghetto-git.svg"} />
                        <p>Git</p>
                    </div>
                    <div className="loghetti inline-block">
                        <Image width="50" height="50" alt="GitHub" title="GitHub" src={"/images/loghetto-github.svg"} />
                        <p>GitHub</p>
                    </div>
                    <div className="loghetti inline-block">
                        <Image width="50" height="50" alt="Tailwindcss" title="Tailwindcss" src={"/images/loghetto-tailwind.svg"} />
                        <p>TailwindCss</p>
                    </div>
                    <div className="loghetti inline-block">
                        <Image width="50" height="50" alt="Bootstrap" title="Bootstrap" src={"/images/loghetto-bootstrap.svg"} />
                        <p>Bootstrap</p>
                    </div>
                </div>
            </div>
